...
export const metadata: Metadata = {
  title: 'Contato | Barbearia do Alves',
  description: 'Entre em contato com a Barbearia do Alves.',
};
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="card animate-slide-up">
          ...
          {siteConfig.professionals.map((pro) => (
            <div key={pro.name} className="flex items-center gap-4 mb-4 last:mb-0">
